...
//--></script>
    ...
    <div id="content" class="col-sm-9">
      ...
      <hr>
                  ...
                  <p><a href="http://wlapps.net/web/17_wl_vidaverde_tvc/index.php?route=product/compare" id="compare-total">Comparación de Productos: (0)</a></p>
      <div class="row">
        <div class="col-md-4">
