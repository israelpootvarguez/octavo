...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-06-2018 a las 13:38:32
...
CREATE TABLE `pacPackagesDescriptions` (
  `pacPackagesDescriptions_Id` int(11) NOT NULL,
...
--
ALTER TABLE `pacPackagesDescriptions`
  MODIFY `pacPackagesDescriptions_Id` int(11) NOT NULL AUTO_INCREMENT;
